...
a("#editor-btn-upload").click(function(){if(b.getId()=="-1"){g.Notice.showMessage("\u65e5\u8bb0\u5c1a\u672a\u88ab\u521b\u5efa, \u8bf7\u5148\u4fdd\u5b58!",1E3);return false}});a(".toolbar-close-btn").live("click",function(){a("#editor-toolbar").simpleTabs("hide");return false});a("#menu>li>a").tipsy({gravity:"s",fake:true})},destroy:function(){}})})(jQuery,Ediary,window);
