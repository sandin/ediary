...
PASSWORD_TOO_SHORT:"\u5bc6\u7801\u81f3\u5c118\u4f4d\u6570",PASSWORD_NOT_SAME:"\u4e24\u6b21\u8f93\u5165\u7684\u5bc6\u7801\u4e0d\u4e00\u6837"});var c=g.i18n.get("Validator");if(typeof jQuery.validator!="undefined"){jQuery.validator.addMethod("alnum",function(b,e){return this.optional(e)||/^[\w]+$/.test(b)});jQuery.validator.addMethod("regex",function(b,e,h){return this.optional(e)||h.test(b)});if(typeof g.i18n!=="undefined"){var d={rules:{email:{required:true,email:true,remote:"/user/account/exists"},
...
g.Validator={init:function(){},options:{errorElement:"span",success:function(b){b.html("Ok!").addClass("valid")}},getRegisterForm:function(){return a.extend({},this.options,d)},getLoginForm:function(){return a.extend({},this.options,f)}}}}},{autoLoad:false})})(jQuery,Ediary,window);
