...
c.origin;c.load=true}else return}f.call(this,this,d)},include:function(c){if(!(c==null||typeof c!="string")){var d=document.createElement("script");d.type="text/javascript";d.charset="utf-8";d.src=c;a.ajaxSetup({cache:true});a("head").append(d)}},loadCSS:function(c){if(!(c==null||typeof c!="string")){var d=top.document.createElement("link");d.rel="stylesheet";d.type="text/css";d.href=c;a.ajaxSetup({cache:true});a("head").append(d)}},destroy:function(){}};window.Ediary=g;g.extend("i18n",function(c){c.i18n=
{languages:{},extend:function(d,f){if(typeof this.languages[d]=="undefined")this.languages[d]=f;return f},get:function(d){if(typeof this.languages[d]!=="undefined")return this.languages[d]}}});g.extend("Date",function(c){c.Date={dayNames:["\u661f\u671f\u5929","\u661f\u671f\u4e00","\u661f\u671f\u4e8c","\u661f\u671f\u4e09","\u661f\u671f\u56db","\u661f\u671f\u4e94","\u661f\u671f\u516d"],dayNamesMin:["\u65e5","\u4e00","\u4e8c","\u4e09","\u56db","\u4e94","\u516d"],monthNames:["\u4e00\u6708","\u4e8c\u6708",
...
this;this.timer=setTimeout(function(){c._resetMessage();c.element.hide()},g)},destroy:function(){this._resetMessage();this.element=null}})})(jQuery,Ediary,window);(function(a,g){g.extend("Pad",{options:{editor:{},notice:{}},init:function(c){this.initEditor(c);return this},initEditor:function(c){a.extend(this.options,c);a("#editor-toolbar").simpleTabs({select:null,useId:true,cache:true,noCache:["editor-btn-upload"]})},destroy:function(){}})})(jQuery,Ediary,window);
...
bindEvent:function(){var d=this,f=this.options;a(f.previewElem).each(function(){a(this).click(function(){var b=a(this).attr("title"),e=f.themeRoot+b+"/style.css";a(f.themeLinkElem).switchTheme({file:e});d.select=b;return false})});a(f.changeElem).click(function(){null!=d.select&&a.ajax({url:f.changeThemeUrl,data:{theme:d.select},success:function(b){b&&b.result&&g.Notice.showMessage("\u6210\u529f\u66f4\u6362\u4e3b\u9898",2E3)}})})},switchTheme:function(d){a(this.options.themeLinkElem).remove();g.loadCSS(d)},
...
initUploadify:function(){var c=this;this.element.uploadify(a.extend({onSelectOnce:function(){c.onSelectOnce.apply(c,arguments)},onAllComplete:function(){c.onAllComplete.apply(c,arguments)},coCancel:function(){c.onCancel.apply(c,arguments)},onComplete:function(){c.onComplete.apply(c,arguments)},onError:function(){}},this.settings.uploadify))},onSelectOnce:function(c){var d=a(this.settings.idElem).val();d!="-1"&&c.target&&a(c.target).uploadifySettings("scriptData",{diary_id:d,PHPSESSID:this.getPHPSESSION()})},
onCancel:function(){},onComplete:function(c,d,f,b){c=this.settings;if(b)try{var e=a.parseJSON(b);if(e.error){b="\u65e0\u6cd5\u4e0a\u4f20\u6587\u4ef6 ";var h=e.error;if(a.inArray("fileMimeTypeFalse",h)!=-1)b+="\u8be5\u6587\u4ef6\u7c7b\u578b\u4e0d\u88ab\u5141\u8bb8 ";if(a.inArray("fileSizeTooBig",h)!=-1)b+="\u8be5\u6587\u4ef6\u8fc7\u5927 ";g.Notice.showMessage(b,1E4)}else a("<li />").append(a("<a />",{href:e.origin,rel:c.fancyboxGroup}).fancybox(c.fancybox).append(a("<img />",{src:e.small,width:c.previewSize[0],
height:c.previewSize[1]}))).append(a("<p />").text(e.filename).append(a("<a />",{"class":"icon_del2_16",href:c.deleteUrl+e.id,html:"&nbsp"}))).appendTo(a(c.targetElem))}catch(i){a.error(i)}else g.Notice.showMessage("\u670d\u52a1\u5668\u65e0\u6cd5\u54cd\u5e94, \u8bf7\u7a0d\u540e\u518d\u8bd5.",5E3)},onAllComplete:function(){},getPHPSESSION:function(){var c=document.cookie.indexOf("PHPSESSID="),d=document.cookie.indexOf(";",c);if(d==-1)d=document.cookie.length;return document.cookie.substring(c+10,d)}}})})(jQuery,
Ediary,window);
