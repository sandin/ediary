...
a("#editor-btn-upload").click(function(){if(d.getId()=="-1"){d.doSave(true);return false}});a(".toolbar-close-btn").live("click",function(){a("#editor-toolbar").simpleTabs("hide");return false});a("#menu>li>a").tipsy({gravity:"s",fake:true})},destroy:function(){}})})(jQuery,Ediary,window);
