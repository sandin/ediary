...
b={form_settings:{rules:{username:{regex:/^[\w\ ]+$/}},messages:{username:{regex:g.i18n.USERNAME_INVALID}}}};g.Validator={init:function(){},options:{errorElement:"span",success:function(e){e.html("Ok!").addClass("valid")}},getRegisterForm:function(){return a.extend({},this.options,d)},getLoginForm:function(){return a.extend({},this.options,f)},getFormOptions:function(e){if(b[e]!=null)return a.extend({},this.options,b[e])}}}}},{autoLoad:false})})(jQuery,Ediary,window);
